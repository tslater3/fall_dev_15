...
@main_menu.length.times do |main_choice|
  puts "#{(main_choice + 1).to_s}. #{@main_menu[(main_choice + 1).to_s][0]}"
end

main_input = gets.chomp # another option would be to call a method with hash @main_menu in it.
